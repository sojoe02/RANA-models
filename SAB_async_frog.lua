...
function init_Ecoqui(x, y, id, macroFactor, timeResolution)
...
function initiateEvent()
	...
	if (Neighbour_2_interval + Neighbour_2_last <= l_currentTime() + (10 * macroF) and energyLevel > 0.8) or
		...
		--force a call if no neighbouring frog has made one:
